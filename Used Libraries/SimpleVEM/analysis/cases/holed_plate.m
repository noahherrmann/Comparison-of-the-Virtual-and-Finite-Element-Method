...
% -------------------------------------------------------------------------
p = 1;
tau_opt = 0.13;              % Example of a second tau value
...
% -------------------------------------------------------------------------
% 4) Create the Geometries (Holed Plate)
% -------------------------------------------------------------------------
% For simplicity, we create the base geometry (for the Voronoi version)
% and three quadrilateral geometries with different refinements.

[~, contour, options] = HoledPlate(1, 0.3, 0.1, 5, 5, 7, 20);
geometry = contour;

% Example of three different mesh refinements for quadrilateral elements
[geom1, contour1] = HoledPlate(1, 0.3, 0.1, 5,  5,  7,  20);
[geom2, contour2] = HoledPlate(1, 0.3, 0.1, 15, 10, 11, 20);
[geom3, contour3] = HoledPlate(1, 0.3, 0.1, 30, 20, 21, 20);
...
% geom_VEM_voro_1 = voronoiDiscretizationRGP(geometry, 500);
% geom_VEM_voro_2 = voronoiDiscretizationRGP(geometry, 1000);
% geom_VEM_voro_3 = voronoiDiscretizationRGP(geometry, 2000);
...
% Additional options
options.meshType = 6;  % Example type (user-defined)
options.p = p;
